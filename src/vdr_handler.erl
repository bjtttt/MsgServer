        ...
        16#200  ->
            case Msg of
                {H} ->
                    ...
                    DBBin = list_to_binary([common:integer_to_binary(YearDB),
                                             common:integer_to_binary(MonthDB),
                                             common:integer_to_binary(DayDB)]),
                    ...
                    VehicleID = State#vdritem.vehicleid,
                    SQL0 = list_to_binary([<<"insert into vehicle_position">>, DBBin,
