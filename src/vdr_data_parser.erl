...
remove_msgidx_4_id(MissingMsgIdxList4Id, ID) when is_list(MissingMsgIdxList4Id),
    ...
    if
        HID == ID ->
            T;
        true ->
            lists:merge([H], remove_msgidx_4_id(T, ID))
    end;
remove_msgidx_4_id(_MissingMsgIdxList4Id, _ID) ->
    [].
