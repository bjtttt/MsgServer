		...
		[{linkpid, LinkPid}] ->
			if
				LinkPid =/= undefined ->
					LinkPid ! {self(), count},
					receive
						{Num1, Num2, Num3, Num4, Num5, Num6, Num7, Num8, Num9, Num10, Num11, Num12, Num13, Num14, Num15, Num16, Num17, Num18, Num19} ->
							Content = list_to_binary([<<78:?LEN_DWORD, 0:?LEN_BYTE, 21:?LEN_BYTE>>,
